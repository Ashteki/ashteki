...
describe('Warcry', function () {
    ...
    describe('On Attack', function () {
        ...
        it('on neighbour attack attach vigor to attacker', function () {
            spyOn(Dice, 'd12Roll').and.returnValue(3);  // attack
            this.player1.endTurn();
            // informs real player of behaviour roll
            expect(this.player2).toHavePrompt('Alerting opponent');
    ...
    describe('On Attack when facedown (BUG)', function () {
        beforeEach(function () {
            this.setupTest({
                mode: 'solo',
                player1: {
        ...
        it('on neighbour attack dont attach vigor to that unit when facedown', function () {
            spyOn(Dice, 'd12Roll').and.returnValue(3);  // attack
            this.player1.endTurn();
            // informs real player of behaviour roll
            expect(this.player2).toHavePrompt('Alerting opponent');
            ...
            expect(this.coalRoarkwin.damage).toBe(1); // no vigor
            expect(this.giantsMight.upgrades.length).toBe(0);
            expect(this.warcry.upgrades.length).toBe(0);

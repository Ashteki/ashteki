describe('Time Dice Power', function () {
    ...
    describe('no unit test', function () {
        beforeEach(function () {
            this.setupTest({
                player1: {
                    phoenixborn: 'aradel-summergaard',
        ...
        it('can remove status from a card when there are no units in play', function () {
            this.player1.clickDie(0);
            this.player1.clickPrompt('Time Dice Power');

            expect(this.player1).toBeAbleToSelect(this.guiltLink);

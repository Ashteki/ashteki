...
class SiegeOfLordswall extends ChimeraCard {
    ...
    getImageStub() {
        ...
        return `siege-of-lordswall-1p-${level}-${this.stage}.jpg`;
    }
...
SiegeOfLordswall.id = 'siege-of-lordswall';

module.exports = SiegeOfLordswall;

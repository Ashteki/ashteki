    ...
    return (
        <Col className='full-height lobby-content' xs='12'>
            <Panel type='lobby' cardClass='learn'>
                ...
                <p>Players who do not play a ranked game (are 'inactive') for over a month will not appear on this list, but will not lose their rating, or have it reduced arbitrarily. Inactive players may pick up where they left off as soon as they play a ranked game, and will again appear on this page.</p>
                <p>New players begin with a score of 1500, but will typically dip below that value while learning the ropes.</p>
